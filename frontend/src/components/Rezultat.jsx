...
export default function Rezultat({history,broj_utakmice,natjecanje,domaci,gosti,golovi_domaci,golovi_gosti,minuta,status,golovi_obrane}) {//props golovi_obrane je za slucaj prikaza igraca i golmana
    ...
    function odvediNaUtakmicu()/*koristimo .replace jer se rezultat box može nalazit na više različitih stranica a treba uvijek vodit na isti page u url pa ne možemo samo pushat na history stack*/
    {
    ...
    return (
        //OVO JE CENTRRIANJE CIJELOG BOXA ZA NASLOVOM-> IME NATJECANJA ĆE BIT CENTRIRANO S NASLOVOM
        ...
        ne ima marginu + 9% i s desne strane marginu i 9% SADRŽAJA-> on ce biti centiran u odnosu na gridlist kao i naslov Rezultati uzivo pa ce biti poravnati
