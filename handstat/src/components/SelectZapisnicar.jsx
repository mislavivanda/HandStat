        ...
        <Fragment>
               <FormControl style={{width:'80%',margin:'0 auto'}}>
                              <Box align='right'><EditIcon/></Box>
                                ...
                                {zapisnicari&&zapisnicari.map((zapisnicar)=><MenuItem key={zapisnicar.maticni_broj} value={zapisnicar}><Typography color='secondary'>{zapisnicar.maticni_broj+' '+zapisnicar.ime+' '+zapisnicar.prezime}</Typography></MenuItem>)}
                                </Select>
                </FormControl>
        </Fragment>
    )
